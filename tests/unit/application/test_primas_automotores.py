...
def sample_primas_df(n: int = 2) -> pl.DataFrame:
    ...
    return pl.DataFrame(
        {
            "femision": pl.Series([date(2025, 1, 15)] * n, dtype=pl.Date),
            "fvigdesde": pl.Series([date(2025, 1, 1)] * n, dtype=pl.Date),
            "fvighasta": pl.Series([date(2026, 1, 1)] * n, dtype=pl.Date),
            "op": pl.Series(list(range(1, n + 1)), dtype=pl.UInt32),
            "componente": pl.Series([1] * n, dtype=pl.UInt32),
            "suplemento": pl.Series([0] * n, dtype=pl.UInt32),
            "cod_rama": pl.Series([10] * n, dtype=pl.UInt32),
            "poliza": pl.Series(list(range(1000, 1000 + n)), dtype=pl.UInt32),
            "aa_componente": pl.Series([50000.0] * n, dtype=pl.Float64),
            "cap": pl.Series([0] * n, dtype=pl.UInt32),
            "var": pl.Series([0] * n, dtype=pl.UInt32),
            "air": pl.Series([5] * n, dtype=pl.UInt32),
            "origen": pl.Series(["N"] * n, dtype=pl.String),
            "anio_componente": pl.Series([2020] * n, dtype=pl.UInt32),
            "cod_cobertura_aut": pl.Series(["A"] * n, dtype=pl.String),
            "cod_tipo_veh": pl.Series([1] * n, dtype=pl.UInt32),
            "cod_uso_veh": pl.Series([1] * n, dtype=pl.UInt32),
            "prima_tarifa_suplemento": pl.Series([1500.0] * n, dtype=pl.Float64),
            "bon_prima_suplemento": pl.Series([0.0] * n, dtype=pl.Float64),
            "premio_suplemento": pl.Series([1500.0] * n, dtype=pl.Float64),
            "premio_cobrado_suplemento": pl.Series([1500.0] * n, dtype=pl.Float64),
            "cod_organizador": pl.Series([10] * n, dtype=pl.UInt32),
            "cod_productor": pl.Series([20] * n, dtype=pl.UInt32),
            "prima_tarifa_componente": pl.Series([1500.0] * n, dtype=pl.Float64),
            "prima_rc_tarifa_componente": pl.Series([300.0] * n, dtype=pl.Float64),
            "prima_casco_tarifa_componente": pl.Series([1200.0] * n, dtype=pl.Float64),
            "prima_neta_componente": pl.Series([1400.0] * n, dtype=pl.Float64),
            "prima_rc_neta_componente": pl.Series([280.0] * n, dtype=pl.Float64),
            "prima_casco_neta_componente": pl.Series([1120.0] * n, dtype=pl.Float64),
        }
    )
